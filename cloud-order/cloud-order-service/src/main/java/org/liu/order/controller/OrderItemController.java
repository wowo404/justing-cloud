...
import org.liu.order.service.OrderItemService;
...
public class OrderItemController {
    ...
    public Response<Page<Long>> pageList() {
        return Response.ok(orderItemService.pageList());
    }
    ...
    public Response<Long> detail(@PathVariable("id") Long id) {
        return Response.ok(orderItemService.detail(id));
    }
    ...
    public Response<Long> add() {
        return Response.ok(orderItemService.add());
    }
