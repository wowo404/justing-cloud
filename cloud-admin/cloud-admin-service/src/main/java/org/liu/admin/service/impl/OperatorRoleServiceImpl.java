...
import org.liu.admin.mapper.OperatorRoleMapper;
...
@Service
public class OperatorRoleServiceImpl extends ServiceImpl<OperatorRoleMapper, OperatorRole> implements OperatorRoleService {
    @Override
