...
6. 把oauth2-client整合到zuul服务后，client的运行机制依赖与cookie，这与微服务架构的无状态特性相违背，spring
   security的RequestCache也是存储到HttpSession中，
   同样依赖cookie，如何解决？
...
- ~~cloud-zuul：10086：以zuul为框架搭建的网关。错误码：以25开头。不再使用~~
